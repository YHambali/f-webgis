    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Kecamatan</h5>
        ...
        <form id="form-data"  method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="row" >
                    <div hidden="">                        
                        <input type="text" id="id_kecamatan" name="id_kecamatan" value="">
                    ...
                    <div id="form-reset" class="row col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" maxlength="150" class="form-control" id="nm_kecamatan"  placeholder="Nama Kecamatan" name="nm_kecamatan" required="">
                            </div>
                        </div>                                              
