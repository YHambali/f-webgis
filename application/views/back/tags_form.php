    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Tags</h5>
        ...
        <form id="form-data"  method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="row" >
                    <div hidden="">                        
                        <input type="text" id="id_tags" name="id_tags" value="">
                    ...
                    <div id="form-reset" class="row col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" maxlength="100" class="form-control" id="nama_tags"  placeholder="Nama Tags" name="nama_tags" required="">
                            </div>
                        </div>                                              
