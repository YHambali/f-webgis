...
<html lang="en">
    ...
    <body data-sidebar="dark">
                        ...
                        <div class="row">
                            <div class="col-12">                              
                                ...
                                ?>       
                                    ...
                                    <div class="card-body">
                                        <div hidden="">
                                            <input type="text" name="id_client" id="id_client" value="<?php echo $id_client ?>">
                                            <input type="text" name="stat" id="stat" value="<?php echo $stat; ?>">
                                        </div>   
                                        <div class="form-group col-lg-12">
                                            <label>Nama Client</label>
                                            <input type="text" class="form-control" name="nm_client" value="<?php echo $nm_client ?>">
                                        </div>   
        ...
        <!-- JS Page -->
        <?php $this->load->view('back/client_js') ?>
    </body>
</html>
