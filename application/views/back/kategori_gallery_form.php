    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Kategori Gallery</h5>
            ...
            <form id="form-data"  method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row" >
                        <div hidden="">                        
                            <input type="text" id="id_kat_gallery" name="id_kat_gallery" value="">
                        ...
                        <div id="form-reset" class="row col-md-12">          
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" maxlength="150" class="form-control" id="nm_kat_gallery"  placeholder="Kategori Gallery" name="nm_kat_gallery" required="">
                                </div>
                            </div>                   
                        </div>                                                
                    </div>
